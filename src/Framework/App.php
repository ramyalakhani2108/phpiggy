...
class App
{
    ...
    public function get(string $path, array $controller) //accept the route name as path and array of data [contoller class and function name]
    {
    ...
    public function post(string $path, array $controller) //accept the route name as path and array of data [contoller class and function name]
    {
